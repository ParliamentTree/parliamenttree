"""
Django settings for Parliament Tree project.
...
SECURE_CHECKS = [
    ...
    "pt.site.checks.check_session_csrf_enabled",
    "pt.site.checks.check_csp_is_not_report_only"
]
...
ROOT_URLCONF = 'pt.site.urls'

WSGI_APPLICATION = 'pt.site.wsgi.application'
